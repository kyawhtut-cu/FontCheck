package com.kyawhtut;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

/**
 * Created by KyawHtut on 5/15/2017.
 */

public class FontUtil {

    private Pattern ZawgyiPattern;
    private String[] ZawGyiToUnipatterns;
    private String[] UniToZawGyipatterns;

    public FontUtil() {
        ZawgyiPattern = Pattern.compile("\u1039[\u1000-\u1021]\u103A|[\u105A\u1060-\u1097]" +
        ...
        ZawGyiToUnipatterns = new String[]
        ...
        UniToZawGyipatterns = new String[]
    ...
    public CharSequence RegexReplace(CharSequence data, CharSequence find, CharSequence replacement) {
    ...
    public boolean isZawgyi(CharSequence input) {
        return ZawgyiPattern.matcher(input).find();
    }

    public CharSequence unicode2zawgyi(CharSequence input) {
        CharSequence output = input;
        final String[] strPatterns = UniToZawGyipatterns;
    ...
    public CharSequence zawgyi2unicode(CharSequence input) {
        CharSequence output = input;
        final String[] strPatterns = ZawGyiToUnipatterns;
        final int patCount = strPatterns.length / 2;
        for (int i = 0; i < patCount; i++) {
            final int idx = i * 2;
            output = RegexReplace(output, strPatterns[idx], strPatterns[(idx + 1)]);
